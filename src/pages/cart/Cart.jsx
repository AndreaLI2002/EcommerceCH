...
function Cart() {
   ...
   *========================================================================**/ 
   initMercadoPago('TEST-057743ac-2013-4057-a19c-db97c65cf7ba', {
    locale: 'es-AR',
    country: 'AR',
  });
  ...
  return (
    <Layout >
      <div className="h-screen bg-gray-100 pt-5 mb-[60%] " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        <h1 className="mb-10 text-center text-2xl font-bold">Items Carrito</h1>
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <div className="flex justify-between">
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>Envío</p>
            ...
            {/* <button  onClick={handleBuy} className="w-full  bg-violet-600 py-2 text-center rounded-lg text-white font-bold ">Comprar Ahora!</button> */}
